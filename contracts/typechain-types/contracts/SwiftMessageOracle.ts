...
export interface SwiftMessageOracleInterface extends Interface {
  ...
  encodeFunctionData(functionFragment: "assignIban", values: [string]): string;
  encodeFunctionData(
    functionFragment: "ibanMapping",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "assignIban", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "ibanMapping",
    data: BytesLike
  ): Result;
...
export namespace AssignIbanEvent {
  export type InputTuple = [wallet: AddressLike, iban: string];
  export type OutputTuple = [wallet: string, iban: string];
...
export interface SwiftMessageOracle extends BaseContract {
  ...
  addressMapping: TypedContractMethod<[arg0: AddressLike], [string], "view">;

  assignIban: TypedContractMethod<[swiftCode: string], [void], "nonpayable">;

  ibanMapping: TypedContractMethod<[arg0: BytesLike], [string], "view">;
  ...
  requestVerification: TypedContractMethod<
    [token: AddressLike, amount: BigNumberish, swiftCode: string],
    [bigint],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "addressMapping"
  ): TypedContractMethod<[arg0: AddressLike], [string], "view">;
  getFunction(
    nameOrSignature: "assignIban"
  ): TypedContractMethod<[swiftCode: string], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "ibanMapping"
  ...
  getEvent(
    ...
    AssignIbanEvent.InputTuple,
    AssignIbanEvent.OutputTuple,
    AssignIbanEvent.OutputObject
  >;
  getEvent(
  ...
  filters: {
    "AssignIban(address,string)": TypedContractEvent<
      AssignIbanEvent.InputTuple,
      AssignIbanEvent.OutputTuple,
      AssignIbanEvent.OutputObject
    >;
    AssignIban: TypedContractEvent<
      AssignIbanEvent.InputTuple,
      AssignIbanEvent.OutputTuple,
      AssignIbanEvent.OutputObject
    >;
